...
HD_PWD='C:/Users/recep/Desktop/28.02.2021_ex_withVivado_AES/aes_vivado/uart/HIGHT/HIGHT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HIGHT_KeySchedule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HIGHT_KeySchedule.tcl
