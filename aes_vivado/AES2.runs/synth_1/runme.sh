...
HD_PWD='C:/Users/recep/Desktop/AES2/AES2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES2Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES2Board.tcl
