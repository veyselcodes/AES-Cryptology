...
#set_property PACKAGE_PIN W15 [get_ports {bytes[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bytes[4]}]
#set_property PACKAGE_PIN V15 [get_ports {bytes[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bytes[5]}]
#set_property PACKAGE_PIN W14 [get_ports {bytes[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bytes[6]}]
#set_property PACKAGE_PIN W13 [get_ports {bytes[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {bytes[7]}]
#set_property PACKAGE_PIN V2 [get_ports {number[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {number[0]}]
#set_property PACKAGE_PIN T3 [get_ports {number[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {number[1]}]
#set_property PACKAGE_PIN T2 [get_ports {number[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {number[2]}]
#set_property PACKAGE_PIN R3 [get_ports {number[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {number[3]}]
...
#set_property PACKAGE_PIN R2 [get_ports {swtch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {swtch}]
